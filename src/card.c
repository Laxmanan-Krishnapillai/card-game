...
char *card_to_string(const Card *card) {
    ...
    char suit_char;
    switch (card->suit) {case SUIT_CLUB: suit_char = 'C'; break;case SUIT_DIAMOND: suit_char = 'D'; break;case SUIT_HEART: suit_char = 'H'; break;case SUIT_SPADE: suit_char = 'S'; break;}
